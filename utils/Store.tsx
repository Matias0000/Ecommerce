...
function reducer(state, action){
    switch (action.type) {
        case 'CARD_ADD_ITEM': {
            ...
            // const exiteProduct = state.Cart.products.findOne((item => item.slug === newItem.slug))
            
            // const productosCart = exiteProduct ? state.Cart.products.map((item) => item.name === existItem.name ? newItem : item): [...state.Cart.products, newItem]
